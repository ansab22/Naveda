            ...
            <div class="md:hidden w-full">
                ...
                <div id="mobileSidebar" class="hidden bg-white p-4 shadow-md">
                    <nav class="space-y-2">
                        ...
                        <a href="{{ route('receptionist.appointments.show') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-200 rounded">Appointment</a>
                        <a href="{{ route('receptionist.contacts.show') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-200 rounded">Contact</a>
                    </nav>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row">
                ...
                <aside class="w-64 bg-[#1B8996] text-white hidden md:flex md:flex-col md:h-screen md:sticky top-0 shadow-md">
                    ...
                    <nav class="p-4 space-y-2 flex-1">
                        ...
                        <a href="{{ route('receptionist.appointments.show') }}" class="block px-4 py-2  hover:bg-white/10 rounded">Appointment</a>
                        <a href="{{ route('receptionist.contacts.show') }}" class="block px-4 py-2 hover:bg-white/10 rounded transition">Contact</a>
