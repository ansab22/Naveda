<div class="flex justify-center items-center h-[80vh] sm:h-[85vh] lg:h-[90vh] bg-fixed bg-cover bg-center bg-no-repeat mt-[0px] lg:mt-[120px]"
    style="background-image: url('images/vedio-img.jpg');">

    <div class="space-y-6 sm:space-y-8 bg-[#f6f6f6] w-full sm:w-[40%] md:w-[90%] lg:w-[55%] mx-[25px] md:mx-auto flex flex-col justify-center items-center p-6 sm:p-6 lg:p-16 border rounded-2xl sm:rounded-3xl">
        ...
        <h1 class="text-[28px] md:text-[38px] lg:text-5xl text-gray-900  leading-tight text-center">
            Personalized Care, Influenced by Sophistication
        </h1>
